...
namespace oly::detail
{
	...
	std::filesystem::path ResourcePath::resource_root; // TODO v10 resource_root should just be the local res/ folder -> copy it to build folder in cmake. likewise, copy shader folder in engine build. no need for macros
