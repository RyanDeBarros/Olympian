...
namespace oly::editor
{
	...
	WindowHintsDesc::WindowHintsDesc() :
		...
		window_position_x(OptionalPrimitive<int>(false, 0), GLFW_ANY_POSITION, detail::Key::PositionX, "Position (X)"),
		window_position_y(OptionalPrimitive<int>(false, 0), GLFW_ANY_POSITION, detail::Key::PositionY, "Position (Y)"),
		window_refresh_rate(OptionalPrimitive<int>(false, 0), GLFW_DONT_CARE, detail::Key::RefreshRate, "Refresh rate"),
