...
namespace oly::editor::gui
{
	...
	DrawResult Combo(const char* label, int& current_item, const std::vector<std::string>& items)
	{
		...
		result |= PropertyGrid::Value::AppendView(std::make_unique<prop::ComboPropertyView>(current_item, LabelSpanRegistry::Intern(items)));
		return result;
	}
	...
	DrawResult InputText(const char* label, std::string& string, size_t max_size, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback, void* user_data)
	{
		...
		if (n != std::string::npos)
			string.resize(n);
		result.Query();
		result |= PropertyGrid::Value::AppendView(std::make_unique<prop::PrimitivePropertyView<std::string>>(string));
		return result;
	}
	...
	DrawResult InputData<bool>::operator()(const char* label, bool& data) const
	{
		...
		result |= PropertyGrid::Value::AppendView(std::make_unique<prop::PrimitivePropertyView<bool>>(data));
		return result;
	}
	...
	DrawResult InputData<int>::operator()(const char* label, int& data) const
	{
		...
		result |= PropertyGrid::Value::AppendView(std::make_unique<prop::PrimitivePropertyView<int>>(data));
		return result;
	}
	...
	DrawResult InputData<int>::operator()(const char* label, int& data, LabelSpanRegistry::Handle names)
	{
		...
		result |= PropertyGrid::Value::AppendView(std::make_unique<prop::ComboPropertyView>(data, names));
		return result;
	}
	...
	DrawResult InputData<float>::operator()(const char* label, float& data) const
	{
		...
		result |= PropertyGrid::Value::AppendView(std::make_unique<prop::PrimitivePropertyView<float>>(data));
		return result;
	}
	...
	DrawResult InputData<double>::operator()(const char* label, double& data) const
	{
		...
		result |= PropertyGrid::Value::AppendView(std::make_unique<prop::PrimitivePropertyView<double>>(data));
		return result;
	}
	...
	DrawResult InputData<glm::vec2>::operator()(const char* label, glm::vec2& data) const
	{
		...
		result |= PropertyGrid::Value::AppendView(std::make_unique<prop::PrimitivePropertyView<glm::vec2>>(data));
		return result;
	}
	...
	DrawResult InputData<glm::vec3>::operator()(const char* label, glm::vec3& data) const
	{
		...
		result |= PropertyGrid::Value::AppendView(std::make_unique<prop::PrimitivePropertyView<glm::vec3>>(data));
		return result;
	}
	...
	DrawResult InputData<glm::vec4>::operator()(const char* label, glm::vec4& data) const
	{
		...
		result |= PropertyGrid::Value::AppendView(std::make_unique<prop::PrimitivePropertyView<glm::vec4>>(data));
		return result;
	}
	...
	DrawResult InputData<Color4>::operator()(const char* label, Color4& data) const
	{
		...
		result |= PropertyGrid::Value::AppendView(std::make_unique<prop::PrimitivePropertyView<Color4>>(data)); // TODO v9.1 AppendView() isn't a good name
		return result;
	}
}
