...
namespace imtk::w
{
	...
	{
		x1.config.label = imtk::label("x1");
		x2.config.label = imtk::label("x2");
		y1.config.label = imtk::label("y1");
		y2.config.label = imtk::label("y2");
	}
	...
	{
		left.config.label  = imtk::label("left");
		right.config.label = imtk::label("right");
		top.config.label   = imtk::label("top");
	}
