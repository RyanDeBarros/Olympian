...
def constructor(paragraph) -> str:
    c = write_transformer_2d(paragraph, 3)
    ...
    c += write_vec4(paragraph, f'{paragraph['name']}.bkg_color', 'bkg color', 3)
    c += write_vec4(paragraph, f'{paragraph['name']}.text_color', 'text color', 3)
