...
namespace oly::physics
{
	...
	public:
		...
		// TODO v9 Here and in KinematicPhysicsComponent in addition to impulses, add net translation vector - which acts similarily to impulses on this frame, but is reversed on next frame so that velocity is not maintained after translating.
