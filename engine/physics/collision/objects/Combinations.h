...
namespace oly::col2d
{
	...
	inline OverlapResult overlaps(const TCompound& c1, const TCompound& c2) { return (c1.get_compound().mask & c2.get_compound().layer) && internal::overlaps(c1, c2); }
	inline CollisionResult collides(const TCompound& c1, const TCompound& c2) { return (c1.get_compound().mask & c2.get_compound().layer) ? internal::collides(c1, c2) : CollisionResult{ .overlap = false }; }
	inline ContactResult contacts(const TCompound& c1, const TCompound& c2) { return (c1.get_compound().mask & c2.get_compound().layer) ? internal::contacts(c1, c2) : ContactResult{ .overlap = false }; }
	inline OverlapResult overlaps(const TCompound& c1, const Compound& c2) { return (c1.get_compound().mask & c2.layer) && internal::overlaps(c1, c2); }
	inline CollisionResult collides(const TCompound& c1, const Compound& c2) { return (c1.get_compound().mask & c2.layer) ? internal::collides(c1, c2) : CollisionResult{ .overlap = false }; }
	inline ContactResult contacts(const TCompound& c1, const Compound& c2) { return (c1.get_compound().mask & c2.layer) ? internal::contacts(c1, c2) : ContactResult{ .overlap = false }; }
	inline OverlapResult overlaps(const Compound& c1, const TCompound& c2) { return (c1.mask & c2.get_compound().layer) && internal::overlaps(c1, c2); }
	inline CollisionResult collides(const Compound& c1, const TCompound& c2) { return (c1.mask & c2.get_compound().layer) ? internal::collides(c1, c2) : CollisionResult{ .overlap = false }; }
	inline ContactResult contacts(const Compound& c1, const TCompound& c2) { return (c1.mask & c2.get_compound().layer) ? internal::contacts(c1, c2) : ContactResult{ .overlap = false }; }
