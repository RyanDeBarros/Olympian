...
namespace oly
{
	...
	// TODO v9 RigidBody should use TransformerRef, not Transformer, to allow for driving physics on any transformer outside of the game object hierarchy.

	// TODO v9 Dialog/decision trees
	// TODO v9 Gameplay utilities such as TypewriterEffect, etc.
	// TODO v9 Rigid Body skeletons (joints, bones/springs, etc.)
	// TODO v11 AI: Navigation, Blackboard Trees, etc.
	// TODO v11 Lighting engine
	// TODO v11 UI widgets
