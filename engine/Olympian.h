...
namespace oly
{
	...
	// TODO v8 RigidBody should use TransformerRef, not Transformer, to allow for driving physics on any transformer outside of the game object hierarchy.

	// TODO v9 AI: Navigation, Blackboard Trees, etc.
	// TODO v9 Dialog/decision trees
	// TODO v9 Gameplay utilities such as TypewriterEffect, etc.
	// TODO v9 Lighting engine
	// TODO v9 UI widgets
	// TODO v9 Rigid Body skeletons (joints, bones/springs, etc.)
	// TODO v10 thread safety + multi-threading.
	// TODO v11 network communication - online/local multiplayer.
}
