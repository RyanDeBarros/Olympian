...
#error "OLYMPIAN_ENGINE_ABS_PATH macro is not defined! Did you forget to configure CMake?"
	...
	// TODO v15 GL_NV_gpu_shader5 is only supported on NVIDIA GPUs. Add support for other GPUs.
	// TODO v15 separate OpenGL/GLFW into independent module - so that different API backends can be implemented, like DirectX and Vulkan
