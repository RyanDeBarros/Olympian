...
namespace oly::particles
{
	...
	{
		c.overload(io::Parser(node).field(_gen::keys::ParticleSystem::C));
	}
	...
	{
		a.overload(io::Parser(node).field(_gen::keys::ParticleSystem::A));
		b.overload(io::Parser(node).field(_gen::keys::ParticleSystem::B));
	}
