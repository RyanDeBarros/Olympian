...
namespace oly::particles
{
	...
	{
		c.overload(io::parse_key(node, _gen::keys::ParticleSystem::C));
	}
	...
	{
		a.overload(io::parse_key(node, _gen::keys::ParticleSystem::A));
		b.overload(io::parse_key(node, _gen::keys::ParticleSystem::B));
	}
