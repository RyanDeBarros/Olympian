...
namespace oly::rendering
{
	...
	public:
		...
		void set_texture(const detail::ResourcePath& texture_file, unsigned int texture_index = 0);
		...
		void set_mod_texture(const detail::ResourcePath& texture_file, unsigned int texture_index = 0);
