...
namespace oly
{
	...
	// TODO v10 use macros for enable booleans. Put them and configurable macros defined in CMakeLists.txt into a project file that is generated by prebuilder. This file needs to therefore be included before Olympian.h.
