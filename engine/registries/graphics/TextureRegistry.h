...
namespace oly::reg
{
	...
	public:
		...
		graphics::BindlessTextureRef load_texture(const ResourcePath& file, unsigned int texture_index = 0, LoadParams params = {});
		graphics::BindlessTextureRef load_svg_texture(const ResourcePath& file, unsigned int texture_index = 0, SVGLoadParams params = {});
		graphics::BindlessTextureRef load_temp_texture(const ResourcePath& file, unsigned int texture_index = 0, TempLoadParams params = {}) const;
		graphics::BindlessTextureRef load_temp_svg_texture(const ResourcePath& file, unsigned int texture_index = 0, TempSVGLoadParams params = {}) const;
	...
	public:
		const graphics::NSVGAbstract& get_nsvg_abstract(const ResourcePath& file) const;
